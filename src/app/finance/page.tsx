...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "예금 이자 계산기, 적금 이자 계산기, 복리 계산기, 예금 vs 적금·CMA vs 예금 비교 계산기, 실질금리·인플레이션 계산기를 무료로 이용하세요. 세전·세후 이자와 만기 수령액, 물가를 반영한 실질금리와 구매력 변화까지 한 곳에서 확인합니다.",
  keywords: ["금융계산기", "예금이자계산기", "적금이자계산기", "복리계산기", "저축계산기", "예금적금비교", "CMA예금비교", "실질금리계산기", "인플레이션계산기"],
});
