...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "대출이자 계산기, 원리금균등·원금균등 상환 계산기, 전세대출 계산기, DSR 계산기, 중도상환 계산기를 무료로 이용하세요. 상환 방식·금리 유형과 스트레스 DSR까지 한 번에 확인합니다.",
  keywords: ["대출계산기", "대출이자계산기", "원리금균등상환", "전세대출계산기", "DSR계산기"],
});
...
const FAQ = [
  ...
  {
    q: "어떤 계산기부터 써야 하나요?",
    a: "대출 총비용이 궁금하면 대출이자 계산기, 매달 갚을 금액과 상환 방식이 궁금하면 원리금상환 계산기를 먼저 이용하세요. 소득 대비 대출 원리금 부담과 스트레스 DSR이 궁금하면 DSR 계산기, 전세 자금이 필요하면 전세대출 계산기, 이미 받은 대출을 미리 갚을지 고민이라면 중도상환 계산기가 적합합니다.",
  },
  {
      ...
      <section className="bg-gradient-to-br from-brand-600 via-brand-600 to-brand-700 px-4 py-14 text-white">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="max-w-xl text-base text-brand-100">
            이자·상환·전세·DSR·중도상환까지 대출 관련 계산기를 한 곳에서 이용하세요.
          </p>
        </div>
      </section>
